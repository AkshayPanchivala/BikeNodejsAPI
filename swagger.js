...
const swaggerDescription = process.env.SWAGGER_DESCRIPTION || 'API documentation for the bike-hub-api project';
const options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Bike Hub API',
      version: '1.0.0',
      description: 'API documentation for the bike-hub-api project',
    },
    tags: [
      {
        name: 'Users',
